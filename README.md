...
5. **[Software Test Automation](https://eric-hastie.github.io/territory-radar/test-automation/)** - run as if the vendor were ContextQA (an illustrative demo, not affiliated with or endorsed by ContextQA). The ICP is mid-market software companies shipping fast where QA is the bottleneck - the tell is a req list full of manual QA engineers and SDETs.
